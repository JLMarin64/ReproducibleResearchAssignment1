...
The mean is `r rmean` and the median is `r rmedian`. The mean is `r rmean` and the median is `r rmedian`. 
...
The max interval, on average across all the days in the dataset is interval `r max`.
...
The median with imputted data is `r rmedian2`. 

The mean with imputted data is `r rmean2`.
